  ...
  container.innerHTML = `
    <div class="fade-in">
      ...
      <div class="cards-grid">
        ...
        <div class="card"><div class="card-label">💸 Monthly Cost</div><div class="card-value red">${fmt(active.reduce((s, r) => s + r.amount * (FREQ_MULT[r.frequency] || 1), 0), settings.currency)}</div></div>
        <div class="card"><div class="card-label">📅 Yearly Cost</div><div class="card-value yellow">${fmt(active.reduce((s, r) => s + r.amount * (FREQ_YEARLY[r.frequency] || 1), 0), settings.currency)}</div></div>
      </div>
      <div class="panel">
